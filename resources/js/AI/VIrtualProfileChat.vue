...
import { generateProfileAgentPrompt } from "@/Resource/VirtualAgent/profileAgentPrompt.js";
...
const agentsConfig = {
    comercial: {
        title: "// DEV_AGENT",
        systemPrompt: generateProfileAgentPrompt(),
        welcome:
            "¡Hola! Soy Dev Agent. ¿Qué quieres saber sobre mí perfil? O cuéntame, ¿qué proyecto deseas que realicemos? Recuerda que nos especializamos en diseñar soluciones y software completamente a la medida.",
    },
};
