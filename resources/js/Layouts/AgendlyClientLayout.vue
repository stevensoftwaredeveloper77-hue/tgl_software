...
const navItems = [
    ...
    {
        href: "/agendly/client/appointment/show",
        label: "Mis citas",
        icon: '<rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="3" y1="10" x2="21" y2="10" />',
    },
    {
        href: "/agendly/client/profile",
        label: "Perfil",
...
const isActive = (href) => {
    if (href === "/cliente") return currentPath.value === "/cliente";
    return currentPath.value.startsWith(href);
};

const isDetailView = computed(() =>
    currentPath.value.includes("/cliente/negocio/"),
);
</script>
...
<template>
    ...
    >
        ...
        <nav
            v-if="!isDetailView"
            class="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border safe-area-bottom"
        >
